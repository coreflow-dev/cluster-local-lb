...
*/}}
{{- define "cluster-local-lb.fullname" -}}
...
*/}}
{{- define "cluster-local-lb.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "cluster-local-lb.resourceName" -}}
{{- $fullname := include "cluster-local-lb.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "cluster-local-lb.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "cluster-local-lb.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
